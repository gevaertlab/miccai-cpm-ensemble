...
class BaselineModel(Model):
    ...
    def add_model(self):
        ...
        with tf.variable_scope('conv1') as scope:
            kernel = tf.get_variable('weights', [5, 5, 5, 4, 30],
                     initializer=tf.contrib.layers.xavier_initializer())
            bias = tf.get_variable('biases', [30],
        ...
        with tf.variable_scope('conv2') as scope:
            kernel = tf.get_variable('weights', [5, 5, 5, 30, 40],
                     initializer=tf.contrib.layers.xavier_initializer())
        ...
        with tf.variable_scope('conv3') as scope:
            kernel = tf.get_variable('weights', [5, 5, 5, 40, 40],
                     initializer=tf.contrib.layers.xavier_initializer())
            bias = tf.get_variable('biases', [40],
                   initializer=tf.constant_initializer(0.0))
        ...
        with tf.variable_scope('conv4') as scope:
            kernel = tf.get_variable('weights', [5, 5, 5, 40, 50],
                     initializer=tf.contrib.layers.xavier_initializer())
            bias = tf.get_variable('biases', [50],
                   initializer=tf.constant_initializer(0.0))
        ...
        with tf.variable_scope('fc1') as scope:
            kernel = tf.get_variable('weights', [1, 1, 1, 50, 100],
                     initializer=tf.contrib.layers.xavier_initializer())
            bias = tf.get_variable('biases', [100],
                   initializer=tf.constant_initializer(0.0))
        ...
        with tf.variable_scope('fc2') as scope:
            kernel = tf.get_variable('weights', [1, 1, 1, 100, 2],
                     initializer=tf.contrib.layers.xavier_initializer())
