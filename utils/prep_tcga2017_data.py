...
HGG_data_path = '/labs/gevaertlab/data/tumor_segmentation/tcga2017/Pre-operative_TCGA_GBM_NIfTI_and_Segmentations'
LGG_data_path = '/labs/gevaertlab/data/tumor_segmentation/tcga2017/Pre-operative_TCGA_LGG_NIfTI_and_Segmentations'
out_path = '/local-scratch/{}_scratch/tcga2017full'.format(user_name)
train_path = '/local-scratch/{}_scratch/tcga2017/train'.format(user_name)
val_path = '/local-scratch/{}_scratch/tcga2017/val'.format(user_name)
