...
class MRIViewerOne:
    ...
    def __init__(self, im1, cmap=None, title1='Image 1'):
        self.i = 0
...
class MRIViewerSlice:

    def __init__(self, im1, im2, im3, im4, cmap, title1='Image 1', title2='Image 2', title3='Image3', title4='Image4', sl=0):
        self.sl = sl
        self.i = 0
